...
import pokemonballs.procedures.GyozaEntityDiesProcedure;
...
public class GyozaEntity extends TamableAnimal implements RangedAttackMob {
	public GyozaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PokeballsModEntities.GYOZA.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PokeballsModItems.LIGHTNING.get()));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GyozaEntity retval = PokeballsModEntities.GYOZA.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PokeballsModEntities.GYOZA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
