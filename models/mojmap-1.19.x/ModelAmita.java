...
public class ModelAmita<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "amita"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leg2 = partdefinition.addOrReplaceChild("Leg2", CubeListBuilder.create().texOffs(-4, -4)
				.addBox(-3.0F, 0.0F, -1.0F, 6.0F, 250.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-72.0F, -247.0F, 0.0F));

		PartDefinition cube_r1 = Leg2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(59, 59).addBox(-1.0F, 0.0F, -1.0F, 3.0F, 3.0F, -57.0F,
		...
		PartDefinition Leg = partdefinition.addOrReplaceChild("Leg", CubeListBuilder.create().texOffs(-4, -4)
				.addBox(-2.0F, 0.0F, -1.0F, 6.0F, 250.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(13.0F, -247.0F, 0.0F));
		...
		PartDefinition cube_r6 = Leg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(59, 59).addBox(-1.0F, 0.0F, -1.0F, 3.0F, 3.0F, -57.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 247.0F, 0.0F, 0.4152F, 0.3215F, 0.1384F));

		PartDefinition cube_r7 = Leg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(59, 59).addBox(-1.0F, 0.0F, -1.0F, 3.0F, 3.0F, -57.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 247.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Leg.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(59, 59).addBox(-1.0F, 0.0F, -1.0F, 3.0F, 3.0F, -57.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 247.0F, 0.0F, 0.4152F, -0.3215F, -0.1384F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(177, 39)
				.addBox(-26.0F, -311.0F, -23.0F, 139.0F, 311.0F, 50.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-72.0F, -247.0F, 0.0F));

		PartDefinition Arm = partdefinition.addOrReplaceChild("Arm", CubeListBuilder.create(),
				PartPose.offset(0.0F, -103.0F, 0.0F));

		PartDefinition cube_r9 = Arm.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(634, 14).addBox(0.0F, -12.0F, -23.0F, 133.0F, 466.0F, 50.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Arm2 = partdefinition.addOrReplaceChild("Arm2", CubeListBuilder.create(),
				PartPose.offset(-268.0F, -103.0F, 0.0F));

		PartDefinition cube_r10 = Arm2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(633, 0).addBox(-126.843F, -12.0F, -19.5759F, 133.0F, 466.0F, 50.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(162.0F, -429.0F, 0.0F, 0.2095F, 0.1582F, 0.933F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 778)
				.addBox(-89.0F, -703.0F, -60.0F, 119.0F, 122.0F, 100.0F, new CubeDeformation(0.0F)),
